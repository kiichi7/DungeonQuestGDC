// Author: abi
// Project: Xbox 360 Copy of DungeonQuest
// Path: C:\code\Xna\DungeonQuestGDC
// Creation date: 10.02.2008 13:05
// Last modified: 10.02.2008 16:08
...
namespace DungeonQuest.Properties
{
	...
	public class GameSettings
	{
		...
		/// </summary>
		const string SettingsFilename = "DungeonQuestSettings.xml";
    ...
    public static GameSettings Default
      ...
      get
		...
		public static void Save()
		{
			...
			{
				// Ignore, may crash on the Xbox 360
			} // catch
		} // Save()
		#endregion
		...
		public string PlayerName
		{
			get
			{
				// No player set yet? Then get from windows user name
				if (String.IsNullOrEmpty(playerName))
					playerName = WindowsHelper.GetDefaultPlayerName();
				return playerName;
			} // get
			set
			{

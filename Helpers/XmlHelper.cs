...
namespace DungeonQuest.Helpers
{
	...
	internal class XmlHelper
	{
		...
		{
			XmlDocument xmlDoc = new XmlDocument();
			// WARNING: This line TAKES A LONG time to load on a Xbox 360, especially
			// with XNA 2.0, I guess there are some issues, was also slow on XNA 1.1,
			// but not in that insane way (crashes for big files with out of memory!)
